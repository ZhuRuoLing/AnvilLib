...
public abstract class AbstractBuilder<R, T extends R, P, S extends AbstractBuilder<R, T, P, S>> implements Builder<R, T, P, S> {
     ...
     *
     * @param type The provider type (which must be a tag provider)
    ...
    private S lang(
        NonNullFunction<T, String> langKeyProvider,
        NonNullBiFunction<RegistrumLangProvider, NonNullSupplier<? extends T>, String> localizedNameProvider
    ) {
        return setData(
            ProviderType.LANG,
