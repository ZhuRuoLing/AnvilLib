...
public class RegistrumRecipeProvider extends RecipeProvider implements RegistrumProvider, RecipeOutput {
    ...
    public static void threeByThreePacker(
        RecipeOutput p_301298_,
        RecipeCategory p_259247_,
        ItemLike p_259376_,
        ItemLike p_259717_,
        String p_260308_
    ) {
    ...
    public static void stonecutterResultFromBase(
        RecipeOutput p_301195_,
        RecipeCategory p_250609_,
        ItemLike p_251254_,
        ItemLike p_249666_,
        int p_251462_
    ) {
    ...
    public void accept(
        ResourceLocation id,
        Recipe<?> recipe,
        @org.jetbrains.annotations.Nullable AdvancementHolder advancement,
    ...
    @Override
    public CompletableFuture<?> buildAdvancement(
        CachedOutput p_253674_,
        HolderLookup.Provider p_323646_,
        AdvancementHolder p_301116_,
        ICondition... conditions
    ) {
