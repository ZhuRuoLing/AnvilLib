...
public class Range implements Iterable<BlockPos> {
     ...
     * @param end   结束点
     */
    public Range(Vec3 start, Vec3 end) {
        this.start = new Vec3(
     ...
     * @return 范围实例
     */
    public static Range of(Vec3 pos, Vec3 range) {
     ...
     * @return 是否包含
     */
    public boolean contains(Vec3 pos, Vec3 range) {
     ...
     * @return 是否交叉
     */
    public boolean cross(Vec3 pos, Vec3 range) {
