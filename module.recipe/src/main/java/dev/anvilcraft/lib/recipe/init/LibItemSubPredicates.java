...
import dev.anvilcraft.lib.recipe.data.advancement.predicate.item.AndPredicate;
import dev.anvilcraft.lib.recipe.data.advancement.predicate.item.NotPredicate;
import dev.anvilcraft.lib.recipe.data.advancement.predicate.item.OrPredicate;
